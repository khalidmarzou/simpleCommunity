...
<main class="py-8 z-10 font-serif w-full h-[90%] flex justify-center">
    <div class="py-16 w-full h-full flex justify-center items center">
        <div class="flex w-full bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <form class="w-full p-8 lg:w-1/2 flex flex-col justify-center items-center" action="/login" method="POST">
                ...
                <div class="mt-4 w-full">
                    ...
                    <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border rounded py-2 px-4 block w-full appearance-none" type="email" id="email" name="email"/>
                    <p class="text-red-500 font-light"><?= $infoIncorrect ?></p>
                </div>
                <div class="mt-4 w-full">
